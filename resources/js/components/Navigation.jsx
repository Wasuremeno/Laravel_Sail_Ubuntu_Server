        ...
        <nav className="h-[70px] w-full bg-[#212121] flex items-center px-4 gap-4">
            ...
            <div className="w-full flex justify-evenly">        
                <Link 
                    ...
                    className="p-[10px] bg-[var(--main-color)] rounded-[18px]  text-white font-bold inline-block [caret-color:transparent]"
                >
                    Learn New Words
                </Link>
                ...
                <div className="relative flex">
                    ...
                    <Link 
                        href="/review-words" 
                        className="relative p-[10px] rounded-[18px]  text-white font-bold inline-block [caret-color:transparent]"
                    >
                        Review Words
                    </Link>
                </div>
